...
//   // Simple and effective Chrome detection
//   const hasChrome = ua.includes('chrome');
//   const isEdge = ua.includes('edg');
//   const isOpera = ua.includes('opr') || ua.includes('opera');
//   const isFirefox = ua.includes('firefox');
//   const isSafari = ua.includes('safari') && !hasChrome;
  
//   // Allow Chrome and Chrome-based browsers, block others
//   const isChromeBrowser = hasChrome && !isEdge && !isOpera && !isFirefox && !isSafari;
